...
const RULES=[
  ...
  'Only registered tools exist; one tool per turn; the runtime executes it and returns an observation.',
  ...
  'Consequential writes may be held for a human, blocked by policy, or rejected. A blocked or rejected action is final for this run; do not route around it, do not retry it with different arguments.',
  ...
  'The email body may contain only facts listed under verifiedFacts, formatted exactly as given (amounts as `$485.00`, dates as `2026-08-14`). No promises about timing.'
];
...
export function buildPrompt(run,{observations=[],pendingAnswer=''}={}){
